...
//	@Router		/students/quiz/{quizId}/delete/{studentId} [delete]
func (qc *QuizController) DeleteStudentFromQuiz(c *gin.Context) {
	...
	err := qc.QuizRepository.DeleteStudentFromQuiz(c, quizId , studentId)
	if err != nil {
		c.JSON(http.StatusBadRequest, models.ErrorResponse{
			Result: []models.ErrorDetail{
				{
					Code:    "ERROR_DELETE_TO_QUIZ",
					Message: "Can't delete to quiz",
